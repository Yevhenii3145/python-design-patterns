...
if __name__ == "__main__":
    ...
    subject.detach(observer_a)  # ConcreteObserverA: Reacted to the event

    subject.some_business_logic()  # ConcreteObserverB: Reacted to the event
